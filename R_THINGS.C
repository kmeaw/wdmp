...
//-----------------------------------------------------------------------------
//
// $Id: r_things.c,v 1.4 1998/01/04 19:29:05 pekangas Exp $
//
...
//
// $Log: r_things.c,v $
// Revision 1.4  1998/01/04 19:29:05  pekangas
// Added hicolor and multiresulution support from Chi Hoang's DOS port
//
// Revision 1.3  1997/12/29 21:17:15  pekangas
// Fixed to compile with Visual C
// Some Win95 fixes
//
// Revision 1.2  1997/12/29 19:51:23  pekangas
...
const char
r_things_rcsid[] = "$Id: r_things.c,v 1.4 1998/01/04 19:29:05 pekangas Exp $";
...
{
    drawseg_t*          ds;
    /* [Petteri] This is a GCCism, not standard C (SCREENWIDTH is not
       constant any longer):
    short               clipbot[SCREENWIDTH];
    short               cliptop[SCREENWIDTH];
    Instead, we'll do an ugly hack (wastes some memory but who cares
    nowadays anyway)
    */
#define MAXWIDTH                        1120
    short               clipbot[MAXWIDTH];
    short               cliptop[MAXWIDTH];
    /* MAXWIDTH comes from r_draw.c */
    int                 x;
    int                 r1;
    int                 r2;
    fixed_t             scale;
