...
#else         
         src = screens[srcscrn]+SCREENWIDTH*REAL_Y(srcy)+srcx; 
         dest   = screens[destscrn]+SCREENWIDTH*REAL_Y(desty)+destx;
#endif
...
#else
         desttop        = screens[scrn]+REAL_Y(y)*SCREENWIDTH+x;
#endif
...
#else
         dest   = screens[scrn] +       REAL_Y(y)*SCREENWIDTH+x;
#endif
...
#else
         src = screens[scrn]    + REAL_Y(y)*SCREENWIDTH+x;
#endif
...
{ 
         ...
         base   = I_AllocLow (SCREENWIDTH*SCREENHEIGHT*5*C_PLAYERNUMBER+255);   // MRMP
...
/*       for (i=0 ;     i<4 ;   i++)
        screens[i] = base       + i*SCREENWIDTH*SCREENHEIGHT;*/
         for (i=0 ;     i<C_PLAYERNUMBER*5 ;    i++)
        screensMP[i] = base     + i*SCREENWIDTH*SCREENHEIGHT;
}
