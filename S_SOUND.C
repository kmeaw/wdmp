...
// MR010798
char g_cSoundedPlayer=0;
boolean g_bSharedSounds=false;
  ...
  int           volume )
{
  ...
  if (origin && origin != players[g_cSoundedPlayer].mo)
  {
    rc = S_AdjustSoundParams(players[g_cSoundedPlayer].mo,
                             origin,
                             &volume,
                             &sep,
                             &pitch);
        
    if ( origin->x == players[g_cSoundedPlayer].mo->x
         && origin->y == players[g_cSoundedPlayer].mo->y)
    {   
      sep       = NORM_SEP;
    }
