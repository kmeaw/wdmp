...
//-----------------------------------------------------------------------------
//
// $Id: f_finale.c,v 1.4 1998/01/04 19:28:55 pekangas Exp $
//
...
//
// $Log: f_finale.c,v $
// Revision 1.4  1998/01/04 19:28:55  pekangas
...
const char
f_finale_rcsid[] = "$Id: f_finale.c,v 1.4 1998/01/04 19:28:55 pekangas Exp $";
...
{ char cPlayer;
	...
	for (cPlayer=0;cPlayer<C_PLAYERNUMBER;cPlayer++)	// MRMP	
	    wipegamestate[cPlayer] = -1;		// force a screen wipe
    castnum = 0;
...
void F_CastDrawer (void)
{
    ...
    if (flip)
	V_DrawPatchFlipped (160+((SCREENWIDTH-320)/2),170+((SCREENHEIGHT-200)/2),0,patch);
    else
