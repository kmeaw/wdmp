...
//-----------------------------------------------------------------------------
//
// $Id: r_plane.c,v 1.5 1998/01/05 14:34:16 pekangas Exp $
//
...
//
// $Log: r_plane.c,v $
// Revision 1.5  1998/01/05 14:34:16  pekangas
// Hacked sky to look better in 4:3 aspect modes
//
// Revision 1.4  1998/01/04 19:29:03  pekangas
...
const char
r_plane_rcsid[] = "$Id: r_plane.c,v 1.5 1998/01/05 14:34:16 pekangas Exp $";
...
void R_DrawPlanes (void)
{
	...
	if (pl->picnum == skyflatnum)
	{
	    dc_iscale = pspriteiscale>>detailshift;
            ...
            /* [Petteri] Hack: Fix the sky for 4:3 aspect: */
            if ( !weirdaspect )
                dc_iscale = FixedMul(dc_iscale,
                                     (fixed_t)((200.0/240.0) *
                                               (double)FRACUNIT));
